...
//		SET_ZONE_DEALER_STRENGTH JEF3a  commented because the hospital is here
	...
	// Gang here: GANG_FLAT(lower area)
		...
		// FIXEDGROVE: obviously meant to be Jefferson (Watts) since the towers are there, so only black spawns now
 		SET_ZONE_POPULATION_RACE ELS3a	POPRACE_B
 		SET_ZONE_POPULATION_RACE ELS3b	POPRACE_B
		SET_ZONE_POPULATION_RACE ELS3c	POPRACE_B // FIXEDGROVE: missing zone added
...
// ******************************************SAN FRAN PEDS ****************************************************
		...
		SET_ZONE_GANG_STRENGTH THEA2 GANG_SFMEX 10
