...
//--- Requests and loads
	IF $txtEntryExit = &TRICAS 
		REQUEST_MODEL TRIADA // FIXEDGROVE: was BMYBOUN
		REQUEST_MODEL TRIADB // FIXEDGROVE: was WMYBOUN
		REQUEST_MODEL TRIBOSS // FIXEDGROVE
...
IF IS_PLAYER_PLAYING PLAYER1
	...
	IF $txtEntryExit = &TRICAS
		...
		CREATE_CHAR_AT_ATTRACTOR PEDTYPE_COP TRIADA iScript_Attractor[8] TASK_WANDER_STANDARD iScriptedAttractorPed[2] // FIXEDGROVE: was BMYBOUN
		CREATE_CHAR_AT_ATTRACTOR PEDTYPE_COP TRIADB iScript_Attractor[9] TASK_WANDER_STANDARD iScriptedAttractorPed[3] // FIXEDGROVE: was WMYBOUN
		CREATE_CHAR_AT_ATTRACTOR PEDTYPE_COP TRIBOSS iScript_Attractor[10] TASK_WANDER_STANDARD iScriptedAttractorPed[4] // FIXEDGROVE: was BMYBOUN
		...
		IF iBouncerAction = 1	
			...
			AND NOT iScript_Attractor[8] = -1 	
				...
				AND NOT IS_POINT_ON_SCREEN fX fY fZ 3.0 
					// FIXEDGROVE: START
					IF $txtEntryExit = &TRICAS
						CREATE_CHAR_AT_ATTRACTOR PEDTYPE_CIVMALE TRIADA iScript_Attractor[8] TASK_WANDER_STANDARD iScriptedAttractorPed[2]			
					ENDIF
					// FIXEDGROVE: END
					IF $txtEntryExit = &MAFCAS
			...
			AND NOT iScript_Attractor[9] = -1
				...
				AND NOT IS_POINT_ON_SCREEN fX fY fZ 3.0
					// FIXEDGROVE: START
					IF $txtEntryExit = &TRICAS
						CREATE_CHAR_AT_ATTRACTOR PEDTYPE_CIVMALE TRIADB iScript_Attractor[9] TASK_WANDER_STANDARD iScriptedAttractorPed[3]			
					ENDIF
					// FIXEDGROVE: END
					IF $txtEntryExit = &MAFCAS
						CREATE_CHAR_AT_ATTRACTOR PEDTYPE_COP VMAFF2 iScript_Attractor[9] TASK_WANDER_STANDARD iScriptedAttractorPed[3]			
			...
			AND NOT iScript_Attractor[10] = -1
				...
				AND NOT IS_POINT_ON_SCREEN fX fY fZ 3.0
					// FIXEDGROVE: START
					IF $txtEntryExit = &TRICAS
						CREATE_CHAR_AT_ATTRACTOR PEDTYPE_CIVMALE TRIBOSS iScript_Attractor[10] TASK_WANDER_STANDARD iScriptedAttractorPed[4]			
					ENDIF
					// FIXEDGROVE: END
					IF $txtEntryExit = &MAFCAS
...
CASAMB_Cleanup:
	...
	MARK_MODEL_AS_NO_LONGER_NEEDED TRIADA // FIXEDGROVE
	MARK_MODEL_AS_NO_LONGER_NEEDED TRIADB // FIXEDGROVE
	MARK_MODEL_AS_NO_LONGER_NEEDED TRIBOSS // FIXEDGROVE
