...
WHILE NOT tag_percentage = 100 //SPRAY 2 BALLAS TAGS************************************************************************************
	...
	IF small_flats_gang = 0
		...
		LVAR_INT sweet1_char_model[3] sweet1_char_select
		sweet1_char_model[0] = ballas1
		sweet1_char_model[1] = ballas2
		sweet1_char_model[2] = ballas3
		// FIXEDGROVE: END

			GENERATE_RANDOM_INT_IN_RANGE 0 3 sweet1_char_select // FIXEDGROVE
			CREATE_CHAR PEDTYPE_MISSION1 sweet1_char_model[sweet1_char_select] 2400.45 -1470.39 22.97 sweet1_flat1 // FIXEDGROVE: was ballas1
			SET_CHAR_HEADING sweet1_flat1  82.40
			GENERATE_RANDOM_INT_IN_RANGE 0 3 sweet1_char_select // FIXEDGROVE
			CREATE_CHAR PEDTYPE_MISSION1 sweet1_char_model[sweet1_char_select] 2396.48 -1469.90 22.99 sweet1_flat2 // FIXEDGROVE: was ballas2
