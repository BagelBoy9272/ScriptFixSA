...
ENDWHILE
	...
	LVAR_INT drive_by_char_model[3] drive_by_char_select
	drive_by_char_model[0] = BALLAS1
	drive_by_char_model[1] = BALLAS2
	drive_by_char_model[2] = BALLAS3
	// FIXEDGROVE: END

	SET_LOAD_COLLISION_FOR_CAR_FLAG drive_by_car FALSE
	GENERATE_RANDOM_INT_IN_RANGE 0 3 drive_by_char_select // FIXEDGROVE
	CREATE_CHAR_INSIDE_CAR drive_by_car PEDTYPE_MISSION2 drive_by_char_model[drive_by_char_select] drive_by_char1 // FIXEDGROVE: was ballas1
	GENERATE_RANDOM_INT_IN_RANGE 0 3 drive_by_char_select // FIXEDGROVE
	CREATE_CHAR_AS_PASSENGER drive_by_car PEDTYPE_MISSION2 drive_by_char_model[drive_by_char_select] 0 drive_by_char2 // FIXEDGROVE: was ballas1
