...
sweet6_m_stage_2:
		...
		IF m_goals = 17
			...
			RESTORE_CAMERA_JUMPCUT
			SET_PED_DENSITY_MULTIPLIER 1.0 // FIXEDGROVE: enable peds when cutscene ends rather than later
			SET_CAR_DENSITY_MULTIPLIER 1.0 // FIXEDGROVE: enable peds when cutscene ends rather than later
		...
		IF m_goals = 99
			...
			//SET_PED_DENSITY_MULTIPLIER 1.0 // FIXEDGROVE: moved
			//SET_CAR_DENSITY_MULTIPLIER 1.0 // FIXEDGROVE: moved
