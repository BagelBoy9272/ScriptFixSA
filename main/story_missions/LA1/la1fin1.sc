...
IF DOES_OBJECT_EXIST g_skylite	
	DELETE_OBJECT g_skylite
ENDIF
IF DOES_OBJECT_EXIST g_vent1
	DELETE_OBJECT g_vent1
ENDIF
IF DOES_OBJECT_EXIST g_vent2
	DELETE_OBJECT g_vent2
ENDIF
IF DOES_OBJECT_EXIST g_trolley1
	DELETE_OBJECT g_trolley1
ENDIF
IF DOES_OBJECT_EXIST g_trolley2
	DELETE_OBJECT g_trolley2
ENDIF
IF DOES_OBJECT_EXIST g_trolley3
	DELETE_OBJECT g_trolley3
ENDIF
IF DOES_OBJECT_EXIST g_trolley4
	DELETE_OBJECT g_trolley4
ENDIF
IF DOES_OBJECT_EXIST g_trolley5
	DELETE_OBJECT g_trolley5
ENDIF
IF DOES_OBJECT_EXIST g_trolley6
	DELETE_OBJECT g_trolley6
ENDIF
IF DOES_OBJECT_EXIST g_trolley7
	...
	AND NOT IS_CAR_DEAD sweet_car
					IF IS_CHAR_SITTING_IN_CAR scplayer sweet_car
						IF LOCATE_CAR_2D sweet_car 2256.239 -1146.909 4.4 4.4 TRUE
							...
							//SET_MAX_WANTED_LEVEL 0 // FIXEDGROVE: commented for new fake wanted level
...
//	ENDIF
	...
	IF motel_interior = 15	//player is inside motel
		...
		SET_PLAYER_CONTROL PLAYER1 ON		 
		SET_CAMERA_BEHIND_PLAYER 
		ALTER_WANTED_LEVEL_NO_DROP PLAYER1 4 // FIXEDGROVE: needed in case they cleared their wanted level
...
MARK_MODEL_AS_NO_LONGER_NEEDED petro
MARK_MODEL_AS_NO_LONGER_NEEDED PETROTR
//SET_MAX_WANTED_LEVEL 4 		///////		WANTED LEVEL ASK FILSHIE ABOUT WHAT IT SHOULD BE SET BACK TO AT THIS POINT // FIXEDGROVE: commented, not needed now
SET_POLICE_IGNORE_PLAYER PLAYER1 FALSE // FIXEDGROVE: needed since it's set to TRUE now
DELETE_CAR extpoliceheli_f1
//blips
	// FIXEDGROVE: while-loop to avoid repeats
	l1f1_count = 0
