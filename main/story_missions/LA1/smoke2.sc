...
//	ENDIF
	...
	AND NOT IS_CAR_DEAD s2_player_car
		IF IS_CHAR_IN_CAR scplayer s2_player_car
			...
			ADD_SPRITE_BLIP_FOR_COORD 2447.3643 -1974.4963 12.5469 RADAR_SPRITE_EMMETGUN s2_weapon_pickup_blip // FIXEDGROVE: corrected coords so they match the global one
